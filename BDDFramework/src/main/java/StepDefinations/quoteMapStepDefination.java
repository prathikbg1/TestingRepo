...
import org.openqa.selenium.support.ui.WebDriverWait;
	...
	public class quoteMapStepDefination {
	    ...
	    public void enters_username_clicks_next(DataTable credentials) throws Throwable {
	    	...
	    	dr.findElement(By.id("login_id")).sendKeys(data.get("username"));
	    ...
	    public void enters_password_clicks_signin(DataTable cred) throws Throwable {
	    	...
	    	dr.findElement(By.id("password")).sendKeys(data.get("password"));
	        Thread.sleep(2000);
	    ...
	    for(Map<String,String> data : addData.asMaps(String.class,String.class)) {
	       dr.findElement(By.id("Crm_Quotes_QUOTESUBJECT")).sendKeys(data.get("subject"));
	       Thread.sleep(2000);
	       dr.findElement(By.id("Crm_Quotes_CONTACTID")).sendKeys(data.get("Contact"),Keys.ARROW_DOWN);
	       Thread.sleep(4000);
	       dr.findElement(By.id("Crm_Quotes_ACCOUNTID")).sendKeys(data.get("Account"),Keys.ARROW_DOWN.ENTER);
	       Thread.sleep(4000);
	       
	       dr.findElement(By.linkText("Add Line Items")).click();
	       dr.findElement(By.id("codein1")).sendKeys("trip",Keys.ARROW_DOWN);
	       Thread.sleep(3000);
	   ...
	   /* @And("^user select save option$")
	    ...
	    public void verify_the_quote_page() throws Throwable {
	    	...
	    	System.out.println(title);
		     Assert.assertEquals("Zoho CRM - Quote Details", title);
	    }
